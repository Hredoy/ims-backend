<aside class="main-sidebar" id="alert2">
    ...
    <section class="sidebar" id="sibe-box">
        ...
        <ul class="sidebar-menu verttop">
            ...
            ?>
                    <li class="treeview <?php echo set_Topmenu('Blog'); ?>">
                        <a href="#">
                            <i class="fa fa-mortar-board ftlayer"></i> <span><?php echo $this->lang->line('blog'); ?></span> <i class="fa fa-angle-left pull-right"></i>
                        </a>
                        <ul class="treeview-menu">
                            <li class="<?php echo set_Submenu('Blog/blog'); ?>">
                                <a href="<?php echo base_url(); ?>admin/blog/index">
                                    <i class="fa fa-angle-double-right"></i>
                                    <?php echo $this->lang->line('blog'); ?>
                                </a>
                            </li>
                            <li class="<?php echo set_Submenu('Blog/category'); ?>">
                                <a href="<?php echo base_url(); ?>admin/blogCategory/index">
                                    <i class="fa fa-angle-double-right"></i>
            ...
            ?>
                    <li class="treeview <?php echo set_Topmenu('AcademicNotice'); ?>">
                        <a href="#">
                            <i class="fa fa-mortar-board ftlayer"></i> <span><?php echo $this->lang->line('academic_message'); ?></span> <i class="fa fa-angle-left pull-right"></i>
                        </a>
                        <ul class="treeview-menu">
                            <li class="<?php echo set_Submenu('AcademicNotice/index'); ?>">
                                <a href="<?php echo base_url(); ?>admin/academic/index">
                                    <i class="fa fa-angle-double-right"></i>
                                    <?php echo $this->lang->line('academic_message'); ?>
                                </a>
                            </li>
                        </ul>
                    </li>
