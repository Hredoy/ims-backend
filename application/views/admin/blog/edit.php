...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <form id="form1" action="<?php echo site_url('admin/blog/update/' . $result['id']) ?>" id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                <div class="col-md-9">
                    <!-- Horizontal Form -->
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('blog'); ?></h3>
                            ...
                            <div class="form-group">
                                ...
                                <select name="category_id" id="category_id" required class="form-control">
                                    ...
                                    <?php foreach ($categories as $category) : ?>
                                        <option value="<?= $category->id ?>" <?php if ((int)$result['category_id'] == (int)$category->id) echo "selected";   ?>><?= $category->name ?></option>
                                    <?php endforeach; ?>
                                </select>
