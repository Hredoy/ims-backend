<div class="row">
    <div class="col-sm-12">
        <div class="card">
                <div class="card-header"><i class="fa fa-search"></i> Exam Result Filter</div>
            <div class="card-body">
                <form role="form" action="<?php echo site_url('exam-results') ?>" method="post">
        ...
        <div class="card">
            <div class="card-body">
                ...
                if (isset($studentList)) {
                    ?>
                    <form method="post" action="<?php echo base_url('admin/examresult/printmarksheet') ?>"
                          id="printMarksheet">
                        ...
                        <div class="">
                            ...
                            <div class="box-header ptbnull">
                                <h3 class="box-title titlefix"><i
                                            class="fa fa-users"></i> <?php echo $this->lang->line('exam') . " " . $this->lang->line('result'); ?>
                                </h3>
                            </div>
                            <div class="box-body">
